---
title: Bookmarks I Actually Use (Stripped Down)
date: 2026-07-11 02:25:14
author: Roy Li
tags: [UtilityScripts, Bookmarks]
...
### Overview
Over the years, I've accumulated hundreds of bookmarks. These are the ones I actually keep coming back to — stripped of the dead links, outdated tools, and fluff. Consider this my own backup, and hopefully a useful reference for fellow engineers.
...
| Site | Purpose |
| :--- | :--- |
| [ip.net.coffee](https://ip.net.coffee) | Check current IP, geolocation, network connectivity and routing |
| [ip111.cn](https://ip111.cn) | Comprehensive IP address query |
| [ip.im](https://ip.im) | IPv4 information lookup |
| [ipleak.net](https://ipleak.net) | WebRTC leak detection |
| [browserleaks.com](https://browserleaks.com/webrtc) | WebRTC IP leak test & browser fingerprinting |
| [whoer.net](https://whoer.net/zh#) | Quick anonymous IP check |
| [ipinfo.io](https://ipinfo.io/what-is-my-ip) | IP geolocation and ASN lookup with API access |
| [whatismyipaddress.com](https://whatismyipaddress.com/) | Public IP address detection |
| [dnschecker.org](https://dnschecker.org) | Global DNS propagation checker |
| [web-check.xyz](https://web-check.xyz) | All-in-one website analyzer: DNS, SSL, headers, WHOIS |

#### 🌐 Network Speed Test
| Site | Purpose |
| :--- | :--- |
| [cegesu.com](https://cegesu.com) | Internet speed test |

#### 🔧 Development Tools
| Site | Purpose |
| :--- | :--- |
| [GitHub](https://github.com) | Code hosting & collaboration |
| [Lighthouse Treemap](https://googlechrome.github.io/lighthouse/treemap/) | Visualize resource load sizes from Lighthouse reports |
| [SimilarSites](https://www.similarsites.com/) | Discover websites similar to any given URL |
| [AlternativeTo](https://alternativeto.net/) | Find alternatives to your favorite software |
| [shots.so](https://shots.so/) | Create mockups, animations and videos for social media and websites |
...
| Site | Purpose |
| :--- | :--- |
| [urlscan.io](https://urlscan.io) | Scan and analyze web pages for malicious behavior |
...
| Site | Purpose |
| :--- | :--- |
| [Random Street View](https://randomstreetview.com) | Explore random Google Street View locations worldwide |
| [Light Pollution Map](https://www.lightpollutionmap.info/) | Find dark skies and check light pollution levels globally |
| [Bongo Cat](https://bongo.cat/) | A fun, interactive drum kit played by a cute cat |
| [YORG.io](https://yorg.io/) | A free online base-building tower defense game |
| [JS Paint](https://jspaint.app/) | Classic MS Paint in your browser |
| [skribbl.io](https://skribbl.io/) | Online multiplayer drawing and guessing game |
| [How Big Is Space](https://www.secaibi.com/howbigisspace/) | Interactive scale model of the universe |
| [Drive From Home](https://drivefromhome.com/) | Virtual road trips — explore the world from your browser |
...
| Site | Purpose |
| :--- | :--- |
| [All History](https://www.allhistory.com/) | Explore world history through an interactive timeline |
| [Gallerix](https://gallerix.asia/) | An online museum featuring thousands of famous paintings |
| [Old Computers](https://oldcomputers.net/) | A vintage computer museum preserving early personal computers |
| [Compumuseum](https://www.compumuseum.com/index.html) | A web-based museum where you can run retro software and games |
| [Famicn](https://www.famicn.com/index.html) | A special exhibition on lost Chinese handheld game consoles |
| [WuxiaWorld](https://www.wuxiaworld.com/) | The largest English library of translated Chinese web novels |
| [Real Banknotes](https://www.realbanknotes.com/money_gallery.html) | High-resolution gallery of world banknotes |
| [Mobile Phone Museum](https://www.mobilephonemuseum.com/) | A visual history of mobile phones from 1984 to today |
| [麦田艺术](https://www.nbfox.com/) | Collect all the world's famous paintings, download watermark-free, high-definition oil paintings for free. |

#### 🛠️ Practical Tools
| Site | Purpose |
| :--- | :--- |
| [VisaIndex](https://visaindex.com/zh-hans/) | Check passport power and visa-free destinations worldwide |
| [PassportIndex](https://www.passportindex.org/cn/) | Comprehensive passport ranking and comparison tool |
| [UK Address Generator](https://www.meiguodizhi.com/uk-address) | Generate random UK addresses for testing purposes |
| [Photo GPS Tag Tool](https://photo-gps.551111.xyz) | Add or edit GPS coordinates in images |
...
| Site | Purpose |
| :--- | :--- |
| [Animated Knots](https://www.animatedknots.com/) | Step-by-step animated guides for tying knots |
| [MuscleWiki](https://musclewiki.com/zh-cn) | Interactive muscle training guide with exercise visualizations |
| [食用手册](https://cook.yunyoujun.cn/) | Recipe and cooking guide collection |
| [Manualslib](https://www.manualslib.com/) | Free user manuals and instruction guides for thousands of products |
| [免费修理手册](https://zh.ifixit.com/) | Step-by-step repair guides for electronics |
| [Instructables](https://www.instructables.com/) | Community-driven DIY projects and tutorials |
| [Fold'NFly](https://www.foldnfly.com/) | Paper airplane folding instructions with video tutorials |

#### 🎬 Media
| Site | Purpose |
| :--- | :--- |
| [SeedHub](https://www.seedhub.cc/) | Torrent and magnet link search engine |
| [Anich](https://anich.emmmm.eu.org/) | Online anime streaming platform |
| [Anime Scene Search Engine](https://trace.moe/) | Reverse search anime screenshots to identify the source |
| [Speedrun.com](https://www.speedrun.com/zh-CN) | Global speedrunning community with records and leaderboards |
| [酷搜影视](https://www.kpkuang.org/) | Movie and TV show resource aggregator |
| [电影天堂](https://www.dygod.vip/) | Movie download resource site |
| [BT世界网](https://www.btsj6.com/) | BT and magnet link search engine |
| [电影天堂(备份网址)](https://www.dytt8899.com/) | Classic movie download site |
| [555影视](https://www.555k26.com/) | Online movie and TV show streaming |
| [555电影](https://www.55dy12.com/) | Online movie and TV show streaming |
| [美剧天堂](https://www.mjtt5.tv/) | Online movie and TV show streaming |
| [B站](https://www.bilibili.com/) | China's leading danmaku video community (anime, tech, gaming) |
| [搜片.com](https://soupian.one/) | Movie and TV show resource aggregator |
| [飘花电影网](https://www.piaohua.com/) | Movie download resource site |
| [盒子助手v1.1.5](https://tvhelper.cpolar.top/) | Live TV streaming tool and source aggregator |
| [Libvio](https://www.libvio.app/) | Movie and TV show resource aggregator |
| [Libvio(备份网址)](https://libvio.host/) | Movie and TV show resource aggregator |
| [JRKAN直播](https://www.jrskk.com/) | Live sports streaming aggregator with multiple backup links |
| [CCTV-5](https://tv.cctv.com/live/cctv5/) | Official CCTV-5 sports channel live stream |
| [CCTV-5+](https://tv.cctv.com/live/cctv5plus/) | Official CCTV-5+ sports event channel live stream |
| [电视眼](https://www.tvyan.com/) | Online TV streaming aggregator with 5,000+ channels |
| [123IPTV](https://www.123iptv.tv/) | Global TV live streaming aggregator |
| [直播吧](https://zhibo8.com/) | Sports live streaming portal with scores, fixtures and text commentary |
...
| Site | Purpose |
| :--- | :--- |
| [Finviz Map](https://finviz.com/map) | US stock market heatmap and sector performance visualization |
| [大盘云图](https://dapanyuntu.com/) | Cloud storage resource search engine |
...
| Site | Purpose |
| :--- | :--- |
| [Dino Game](https://dinogame.onl/) | Play the classic Chrome dino game online in your browser |
| [Emu666](https://www.emu666.com/) | Web-based retro game emulator collection |
| [小霸王在线游戏](https://www.yikm.net/) | Play classic NES and arcade games online in your browser |
| [Poki (宝玩)](https://poki.com/zh) | Free online mini-games platform |
| [老游戏在线玩](https://zaixianwan.app/) | Web-based retro game emulator (FC, PS, GBA, etc.) |
| [Play-CS](https://play-cs.com/zh/servers) | Counter-Strike server browser and status checker |
| [Switch问题自查](https://docs.qq.com/doc/DVVFMWXRLQ096RXVG) | A comprehensive FAQ and troubleshooting document for Switch |
| [TX转大气层方图文教程](https://www.2023game.com/nsaita/pojie/79480.html) | Guide and tools for migrating from TX to Atmosphere on Switch |
| [【工具】switch《19.0.1系统大气层1.8.0版本》纯净包、极简整合包下载2](https://www.2023game.com/nsaita/pojie/163211.html) | Atmosphere CFW package and tools for Switch firmware 19.0.1 |
| [Switch 大气层 Atmosphere 如何离线升降级系统](https://shipengliang.com/games/switch-%E5%A4%A7%E6%B0%94%E5%B1%82-atmosphere-%E5%A6%82%E4%BD%95%E7%A6%BB%E7%BA%BF%E5%8D%87%E7%BA%A7%E7%B3%BB%E7%BB%9F.html) | Tutorials on upgrading/downgrading Switch firmware with Atmosphere |
| [Switch520](https://www.gamer520.com/) | A popular site for downloading Switch games and resources |
| [switch游戏联盟(常用教程列表)](https://mp.weixin.qq.com/mp/appmsgalbum?__biz=MzI3MjE2ODMzOA==&action=getalbum&album_id=1492482265908559872&scene=173&from_msgid=2247510746&from_itemidx=3&count=3&nolastread=1#wechat_redirect) | Nintendo Switch List of frequently used tutorials |
| [希望OL美服 希望恋曲 冰城套装任务详解(上下鞋)](https://blog.sina.com.cn/52seal) | A blog with guides and tips for the MMO game *Seal Online* |
| [Seal Online KR Official](https://www.sealonline.co.kr/Event/Event_20240214) | Official event page for the Korean server of *Seal Online* |
| [希望OL美服官网](https://sealonline.playrohan.com/main.html) | Seal Online community portal and player resources |
| [希望宝典-希望online资料站数据库](https://www.2usealol.com/) | Seal Online game database with items, monsters, and equipment info |
| [希望OL国服锐我官网](https://sealonline.ruiwoo.cn/Index/index.html) | Seal Online official website and game client download |
| [Seal B.O.D Official Wiki](https://sealonline.fandom.com/wiki/Main_Page) | Community-driven Seal Online encyclopedia on Fandom |
| [《跑跑卡丁车》官网](https://popkart.tiancity.com/homepage/v3/) | Official website of the popular racing game Popkart (Crazy Racing) |
| [IGG-Games](https://igg-games.com/) | PC game downloads including cracked and torrent resources |
